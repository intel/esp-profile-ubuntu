...
Intended to be used with Retail Node Installer and Ubuntu base profile, this Ubuntu OS profile contains a few files that ultimately will install Ubuntu OS with Retail Workload Orchestrator to disk.
